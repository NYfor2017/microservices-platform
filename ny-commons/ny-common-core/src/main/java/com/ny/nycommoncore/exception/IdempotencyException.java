...
import com.ny.nycommoncore.model.Result;
...
public class IdempotencyException extends RuntimeException{
    ...
    /**
     * AccessDeniedException 异常处理返回json
     * 返回状态码：403
     *
     * @param e
     * @return
    ...
    public Result handleHttpRequestMethodNotSupportException(HttpRequestMethodNotSupportedException e){
